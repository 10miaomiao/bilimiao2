...
//    const val compose = "1.7.0-beta04"
    const val composeBox = "2024.06.00"
...
object Libraries {
    ...
    // compose基础组件
    const val composeBom = "androidx.compose:compose-bom:${Versions.composeBox}"
    const val composeUi = "androidx.compose.ui:ui"
    const val composeFoundation = "androidx.compose.foundation:foundation"
    const val composeUiToolingPreview = "androidx.compose.ui:ui-tooling-preview"
    const val composeAnimation = "androidx.compose.animation:animation"
    const val composeMaterial = "androidx.compose.material:material:1.7.0-beta04"
