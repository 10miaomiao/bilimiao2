...
fun BottomBar(
    ...
    NavigationBar {
        items.forEach { destination ->
            val isCurrentDestOnBackStack = navCtrl.isRouteOnBackStack(destination.dest)
            NavigationBarItem(
...
sealed class BottomBarDestination(@StringRes val label: Int, val dest: DirectionDestination, val icon: ImageVector) {
    data object Self : BottomBarDestination(R.string.self, SelfScreenDestination, Icons.Filled.AccountCircle)
    data object Home : BottomBarDestination(R.string.home, HomeScreenDestination, Icons.Filled.Home)
    data object Settings: BottomBarDestination(R.string.settings, SettingsScreenDestination, Icons.Filled.Settings)
}