...
public class MyIjkPlayerManager extends BasePlayerManager {
    ...
    public void initVideoPlayer(Context context, Message msg, List<VideoOptionModel> optionModelList, ICacheManager cacheManager) {
        ...
        mediaPlayer.setOption(IjkMediaPlayer.OPT_CATEGORY_FORMAT, "user_agent", "Bilibili Freedoooooom/MarkII");
    ...
    public static void setIjkLibLoader(IjkLibLoader ijkLibLoader) {
        MyIjkPlayerManager.ijkLibLoader = ijkLibLoader;
    }
    ...
    public static void setLogLevel(int logLevel) {
        MyIjkPlayerManager.logLevel = logLevel;
    }
}
