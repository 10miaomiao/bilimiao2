...
private class TelVerifyPageViewModel(
    ...
    fun sendClick() {
        geetestVerifier.startVerification(this@TelVerifyPageViewModel)
    }
    ...
    override suspend fun onResult(
        ...
        if (verifyType.value == VerifyType.TEL) {
            ...
            GlobalToaster.show("未知类型")
            return false
        }
    }

    override suspend fun getApiJson(): JsonObject? {
        val res = withContext(Dispatchers.IO) {
