...
import cn.a10miaomiao.bilimiao.compose.common.download.createLocalPlayerSource
...
internal class DownloadDetailPageViewModel(
    ...
    fun loadDownloadDetail(
        ...
        downloadManager.curDownload.collect {
    ...
    private fun _loadDownloadDetail(
        ...
        val list = downloadManager.readDownloadDirectory(dirPath)
    ...
    fun itemClick(item: DownloadItemInfo) {
        if (item.is_completed) {
            basePlayerDelegate.openPlayer(createLocalPlayerSource(
    ...
    fun startClick(item: DownloadItemInfo) {
        downloadManager.startDownload(item.dir_path)
    }
    ...
    fun deleteDownload(
        ...
        downloadManager.deleteDownload(info.dir_path, item.dir_path)
